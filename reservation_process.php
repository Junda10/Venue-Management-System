...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        if ($stmt_venue === false) {
            echo "Error preparing venue statement: " . $conn->error;
            exit();
        }
        ...
        if ($stmt_slot === false) {
            echo "Error preparing slot statement: " . $conn->error;
            exit();
        }
        ...
        if ($stmt_overlap === false) {
            echo "Error preparing overlap statement: " . $conn->error;
            exit();
        }
        ...
        echo "<h3>Database Error during Booking</h3>";
        echo "<p>Message: " . htmlspecialchars($e->getMessage()) . "</p>";
        echo "<p><a href='reservation.php'>Go back to reservation</a></p>";
        echo "</div>";
